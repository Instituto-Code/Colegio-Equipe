    ...
    return (
        <>
            ...
            <Slider1 imagens={imagens_Slide1}>
                <div className="flex flex-col z-10 absolute items-center m-[5vw] p-5 text-center rounded-[30px] bg-[rgba(255,255,255,0.8)] sm:flex-row sm:justify-around sm:py-[6vw] sm:px-[5vw] sm:text-left [630px]:gap-[1vw]">
