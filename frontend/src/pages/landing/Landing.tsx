    ...
    export const LandingPage = () => {
        ...
        return (
            <>
                <header className="flex w-full justify-between items-center p-1">
                    <div className="flex" >
                        <img src={img_header} className="w-[7vw] max-sm:w-[25vw] " />
                    </div>
                    <div className="flex items-center pr-[1.5vw] gap-[3vw]">
                        <a className="flex max-sm:hidden text-black justify-center font-normal text-[1.2vw] font-[Inter] cursor-pointer no-underline [630px]:hidden" href="#sections_texts">Quem somos</a>
                        <a className="flex max-sm:hidden text-black justify-center font-normal text-[1.2vw] font-[Inter] cursor-pointer no-underline [630px]:hidden" href="#text_mission">Propósitos</a>
                        {(user && token) ? (
                            <>
                                <DropdownMenu modal={false}>
                                    <DropdownMenuTrigger asChild>
                                            <Avatar className="h-[clamp(2.8rem,3.5vw,4.5rem)] aspect-square">
                                                <AvatarImage src="https://github.com/shadcn.png" className=""/>
                                                <AvatarFallback>U</AvatarFallback>
                                            </Avatar>
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent className="flex flex-col gap-2 bg-white p-5 overflow-auto cursor-pointer shadow-[0_0px_6px_rgba(0,0,0,0.4)] mr-2 mt-2 rounded text-center">
                                        <DropdownMenuItem className="hover:bg-gray-200 p-1.5 rounded text-xl hover:outline-0">{user.name}</DropdownMenuItem>
                                        <DropdownMenuItem className="hover:bg-gray-200 p-1.5 rounded text-xl hover:outline-0">Configurações</DropdownMenuItem>
                                        <DropdownMenuItem 
                                            className="bg-red-500 p-1.5 rounded  text-xl outline-none"
                                            onClick={logout}
                            ...
                            <button className="flex h-[2.4vw] max-sm:h-[10vw] justify-center items-center font-normal text-[1.3vw] max-sm:text-[4.5vw] font-[Inter] p-[1.2vw] max-sm:p-0 bg-[#D9D9D9] border-0 rounded-[10px] cursor-pointer w-auto max-sm:w-[30vw]">
                ...
                <Slider1 imagens={imagens_Slide1}>
                    <div className="flex flex-col z-1 absolute items-center m-[5vw] p-5 text-center rounded-[30px] bg-[rgba(255,255,255,0.8)] sm:flex-row sm:justify-around sm:py-[6vw] sm:px-[5vw] sm:text-left [630px]:gap-[1vw]">
                        <div className="flex flex-col gap-[4vb]">
                            <h1 className="font-[Inter] text-[clamp(1.5rem,4vw,4.5rem)] ">Transforme seu futuro com educação de qualidade !</h1>
                            <h2 className="font-normal font-[Inter] text-[clamp(0.7em,1.5vw,2em)]">Na vanguarda da inovação educacional, nosso compromisso é transformar o aprendizado em uma experiência significativa e acessível para todos. Explore novos horizontes com métodos de ensino de ponta e recursos personalizados que atendem às necessidades dos alunos modernos.</h2>
                        </div>
                        <div className="flex items-center">
                            <img src={img_logo} className=" w-[clamp(30vw,100vw,200vw)]" alt="" />
                        </div>
                    </div>
                </Slider1>

                <section className="flex justify-center items-center my-[2vw]" id="sections_texts">
                    <div className="flex flex-col w-[95%] p-[0vw_5vw_5vw_5vw] max-sm:p-[5vw_5vw_10vw_5vw] shadow-[0px_0px_15px_rgb(141,141,141)] rounded-[1vw]">
                        <h1 className="font-[Kumbh_Sans] font-light text-[5vw] max-sm:text-[3rem] max-sm:text-center my-[4vw]">Quem somos?</h1>
                ...
                <section className="flex justify-center items-center my-[2vw]" id="text_mission">
                    <div className="flex items-center justify-between w-[95vw] rounded-[1vw] shadow-[0px_0px_15px_rgb(141,141,141)] max-sm:flex-col max-sm:justify-center max-sm:items-center">
                        <div className="flex flex-col mt-[4vw] mr-[20vw] mb-0 ml-[5vw] max-sm:mt-[10vw] max-sm:mr-0 max-sm:ml-0 max-sm:items-center">
                            <div className="flex flex-col">
                                <h1 className="font-[Kumbh_Sans] font-light text-[5vw] max-sm:text-[2.4rem] max-sm:m-0">Missão</h1>
                                <div className="flex items-center">
                ...
                <section className="flex justify-center items-center my-[2vw]">
                    <div className="flex items-center justify-between w-[95vw] rounded-[1vw] shadow-[0px_0px_15px_rgb(141,141,141)] bg-[rgba(217,217,255,0.3)] max-sm:flex-col max-sm:justify-center max-sm:items-center">
                        <div className="flex flex-col mt-[4vw] mr-[20vw] mb-0 ml-[5vw] max-sm:mt-[10vw] max-sm:mr-0 max-sm:ml-0 max-sm:items-center">
                            <div className="flex flex-col">
                                <h1 className="font-[Kumbh_Sans] font-light text-[5vw] max-sm:text-[2.4rem] max-sm:m-0">Visão</h1>
                                <div className="flex items-center">
                ...
                <section className="flex justify-center items-center my-[2vw]">
                    <div className="flex items-center justify-between w-[95vw] rounded-[1vw] shadow-[0px_0px_15px_rgb(141,141,141)] max-sm:flex-col max-sm:justify-center max-sm:items-center">
                        <div className="flex flex-col mt-[4vw] mr-[20vw] mb-0 ml-[5vw] max-sm:mt-[10vw] max-sm:mr-0 max-sm:ml-0 max-sm:items-center">
                            <div className="flex flex-col">
                                <h1 className="font-[Kumbh_Sans] font-light text-[5vw] max-sm:text-[2.4rem] max-sm:m-0">Valores</h1>
                                <div className="flex items-center">
