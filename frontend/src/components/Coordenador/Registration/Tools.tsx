        ...
        <>
            ...
            <Dialog open={showNewDialog} onOpenChange={setShowNewDialog}>
                <DialogContent className="sm:max-w-[500px] ">
                    ...
                    >
                        <DialogHeader >
                            <DialogTitle className="mb-5">Vincular o aluno a um responsável</DialogTitle>
                            ...
                            <div className="flex flex-col sm:items-start">
                                <FieldLabel htmlFor="resposável" className="mb-1 justify-cente">Selecione o responsável</FieldLabel>
                                <Controller
                                    name="parente"
                                    control={control}
                                            ...
                                            <Popover open={open} onOpenChange={setOpen}>
                                                <PopoverTrigger asChild>
                                                    ...
                                                    >
                                                        ...
                                                        {field.value
                                                            ? parents.find((parent) => parent.id === field.value)?.nome
                                                ...
                                                <PopoverContent className="w-[250px] p-0">
                                                    <Command>
                                                        ...
                                                        />
                                                        {loading ? (
                                                            <CommandEmpty>Buscando Responsáveis... </CommandEmpty>
                                                        ) : (
                                                            <CommandGroup>
                                                                {parents
                                                                    .filter((parent) =>
                                                                        parent.nome.toLowerCase().includes(searchTerm.toLowerCase())
                                                                    )
                                                                    .map((parent) => (
                                                                        <CommandItem
                                                                            key={parent.id}
                                ...
                                />
                                {errors.parente && (
                                    <p className="text-red-500 text-sm mt-1">{errors.parente.message}</p>
                                )}
                            </div>
